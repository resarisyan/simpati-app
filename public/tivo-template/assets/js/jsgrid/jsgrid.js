(function($) {
    ...
    $("#basicScenario").jsGrid({
        ...
        fields: [
            ...
            { name: "Email", type: "text", width: 220 },
            { name: "Phone", type: "text", width: 150 },
            { name: "Assign", type: "text", width: 300 },
    ...
    $("#sorting-table").jsGrid({
        ...
        fields: [
            ...
            { name: "Product", type: "text", width: 220 },
            { name: "Order Id", type: "text", width: 140 },
            { name: "Price", type: "text", width: 100 },
            { name: "Quantity", type: "text", title: "Quantity", width: 120 },
    ...
    $("#batchDelete").jsGrid({
        ...
        fields: [
            ...
            { name: "Employee Name", type: "Text", width: 180 },
            { name: "Salary", type: "text", width: 100 },
            { name: "Skill", type: "text", width: 60 },
            { name: "Office", type: "text", width: 140 },
