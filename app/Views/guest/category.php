...
<meta name="keywords" content="SIMPATI Desa Sukamanah - <?= $category['title']; ?>">
<?= $this->endSection() ?>
<?= $this->section('main') ?>
<section class="" style="
        ...
        <div class="row mb-8 justify-content-center">
            <div class="col-md-12 text-center card-wrapper">
                <div class="card border-0 rounded shadow">
                    <img src="<?= base_url('uploads/' . $category['image']) ?>" alt="<?= $category['title']; ?>" class="img-fluid rounded" width="100%" height="100%">
                </div>
                <div class="card-body">
