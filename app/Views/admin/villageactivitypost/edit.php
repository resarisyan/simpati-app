...
<div class="col-sm-12">
    <div class="card">
        ...
        <div class="card-body add-post">
            <form class="row" method="POST" action="<?= route_to('village_activity_post_update', $category_slug, $data['id']) ?>" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PUT">
                <?= csrf_field() ?>
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="title">Title:</label>
                        <input name="title" class="form-control <?= session()->has('errors') && session('errors')['title'] ? 'is-invalid' : '' ?>" id="title" type="text" aria-label="title" value="<?= $data['title'] ?>">
                    ...
                    <div class="email-wrapper">
                        <div class="theme-form">
                            <div class="form-group">
                                ...
                                <textarea name="content" id="text-box" name="text-box" cols="10" rows="2" class="form-control <?= session()->has('errors') && session('errors')['content'] ? 'is-invalid' : '' ?>"><?= $data['content'] ?></textarea>
