...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="page-body-wrapper">
            ...
            <div class="sidebar-wrapper">
                <div>
                    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="<?= base_url('tivo-template/assets/images/logo/logo.png') ?>" alt=""></a>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header pb-0">
                                        <?php if (isset($create)) : ?>
                                            <a class="btn btn-sm btn-primary" href="javascript:void(0)" id="btnCreate">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive theme-scrollbar">
                                        <?php if (isset($forms)) : ?>
                                            <table id="dataTable" class="table-responsive theme-scrollbar">
                                                <thead>
                                                    <tr>
    ...
    <script src="<?= base_url('tivo-template/assets/js/sweet-alert/sweetalert.min.js') ?>"></script>
    <script src="<?= base_url('tivo-template/assets/js/sweet-alert/app.js') ?>"></script>
